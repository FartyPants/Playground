...
You can dump all adapters to a folder (so you can have the merged adapter as own LoRA) Note: if you are using 4-bit, then the saved LoRA will come up half size of the original loRA
## LORA switch
